...
import com.skyretro.iptv.data.emby.ConnectServer
import com.skyretro.iptv.data.emby.EmbyRepository
import com.skyretro.iptv.databinding.ActivityEmbyLoginBinding
...
class EmbyLoginActivity : AppCompatActivity() {
    ...
    private fun selectTab(connect: Boolean) {
        ...
        val activeText   = getColor(R.color.sky_dark_blue)

package com.skyretro.iptv.ui.favourites

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.skyretro.iptv.data.model.FavouriteItem
import com.skyretro.iptv.databinding.ItemFavouriteBinding
...
class FavouritesAdapter(
    ...
    inner class VH(private val b: ItemFavouriteBinding) : RecyclerView.ViewHolder(b.root) {
        ...
        fun bind(item: FavouriteItem, position: Int) {
            ...
            b.tvSubtitle.text = when {
                item.type == com.skyretro.iptv.data.model.FavType.EPISODE ->
                    "S${item.season}E%02d".format(item.episodeNum)
                else -> "MOVIE"
            }
        ...
        private fun applyColors(position: Int, focused: Boolean) {
            ...
            b.tvTitle.setTextColor(if (focused) 0xFFFFCC00.toInt() else 0xFFFFFFFF.toInt())
        }
    }
}

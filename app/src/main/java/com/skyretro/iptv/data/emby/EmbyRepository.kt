...
class EmbyRepository {
    ...
    companion object {
        private const val FIELDS       = "UserData,ImageTags,SeriesPrimaryImageTag"
    ...
    suspend fun requestPin(): Result<ConnectPinResponse> = runCatching {
        ...
        val body = "deviceId=skyretro-android"
    ...
    fun buildStreamUrl(serverUrl: String, itemId: String, token: String, source: EmbyMediaSource? = null): String {
        ...
        return "${base}Videos/$itemId/$path?api_key=$token&Static=true&MediaSourceId=$mediaSourceId&DeviceId=skyretro-android"
    }
    ...
    private fun baseHeader() =
        "MediaBrowser Client=\"SkyRetro\", Device=\"SkyRetro\", DeviceId=\"skyretro-android\", Version=\"1.4\""
